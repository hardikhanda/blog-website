      ...
      {userData && (
        <div className="bg-white py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h1 className="text-3xl font-bold text-black text-center mb-6">Welcome, {userData.name}! Explore Your Dashboard</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white shadow-md rounded-lg p-6">
                ...
                <p className="text-black">Total Likes: {totalLikes}</p>
              ...
              <div className="bg-white shadow-md rounded-lg p-6 " style={{ maxHeight: '200px', overflowY: 'auto', scrollbarWidth: 'thin', scrollbarColor: 'white #ccc' }} >
