  ...
  return (
    <div className="fixed z-50 w-full max-w-lg bottom-4 left-1/2 transform -translate-x-1/2 bg-gray-900 border border-gray-700 dark:bg-gray-800 dark:border-gray-600 rounded-full">
      <div className="grid h-full grid-cols-5 mx-auto max-w-lg">
        ...
        <Link to="/home" className="inline-flex flex-col items-center justify-center px-5 rounded-s-full hover:bg-gray-800 dark:hover:bg-gray-700 group">
          <button
        ...
        {/* Analytics Button and Tooltip */}
        {userData &&
        <Link to={`/analytics/${userData._id}`} className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-800 dark:hover:bg-gray-700 group">
          <button
        ...
        <div className="flex items-center justify-center">
          <Link to="/create-post" className="inline-flex items-center justify-center w-10 h-10 font-medium bg-blue-600 rounded-full hover:bg-blue-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
            <button
        ...
        <Link to="/dashboard/recent-posts" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-800 dark:hover:bg-gray-700 group">
          <button
        ...
        <Link to="/dashboard/user" className="inline-flex flex-col items-center justify-center px-5 rounded-e-full hover:bg-gray-800 dark:hover:bg-gray-700 group">
          <button
