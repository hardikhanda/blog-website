    ...
    <footer className="text-gray-400 bg-gray-800 body-font">
        ...
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a href="#" className="flex title-font font-medium items-center md:justify-start justify-center text-white">
            <img
              ...
              style={{
                height: '120px', // Adjust the height to fit your footer
                width: 'auto', // Maintain aspect ratio
              }}
            />
            <span className="ml-3 text-xl">PEC IMPULSE</span>
          </a>
      ...
      <div className="bg-gray-800 bg-opacity-75">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          <span className="inline-flex ml-auto sm:ml-0 mt-2 sm:mt-0 justify-center">
